...
T031 (T000-T002, T010, T011, T014, T015, T020-T026, T030 complete;
T027 PARTIAL — see database/INDEX_REVIEW.md; T012/T013 prepared but
blocked on user action).

## Active files

``` text
None yet — T031 has not started.
```
